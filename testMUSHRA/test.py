...
# ===================================================================
# INCOLLA QUI IL TUO TOKEN NGROK (tra le virgolette)
# ===================================================================
...
if __name__ == "__main__" and not os.environ.get('WERKZEUG_RUN_MAIN'):
    ...
    run_command(f"{sys.executable} -m pip install -q pyngrok gdown")
    ...
    # 5. Avvio Ngrok e STAMPA DEGLI URL
    print("🔗 5. Avvio del tunnel Ngrok...")
...
# Chiamiamo il CLI principale con l'argomento 'server'
# Questo deve essere fuori dal blocco if per permettere al server di riavviarsi con Flask reload
if __name__ == "__main__":
    from pymushra.cli import cli
    cli(['server'])